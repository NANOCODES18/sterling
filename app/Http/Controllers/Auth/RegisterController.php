...
//send user registration email   
        ...
        $name = $data['name'];
        $mail = " Welcome to Sterlions!<br>
        We're so glad you've joined us during this exciting and transformative time. As an Member of Sterlion, you'll have access to all the financial tools and insights that make our approach extraordinary.
