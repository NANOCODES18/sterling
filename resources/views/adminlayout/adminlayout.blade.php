					...
					<ul>
						...
						<li class="has_sub">
							...
							<ul class="list-unstyled" style="display: block;">
								...
								<li class=""><a href="{{route('viewproofs')}}">View Deposits proofs</a></li>
							</ul>
						</li>
						<li class="has_sub">
						...
						<li class="has_sub">
							<a href="#" class="waves-effect subdrop">
								...
								<span> Copying Trades </span>
								<span class="pull-right">
									<i class="fa fa-window-minimize" aria-hidden="true"></i> 
								</span>
							</a>
							<ul class="list-unstyled" style="display: block;">
								<!-- Link to Create Trader -->
								<li class="">
									<a href="{{ route('admin.traders.create') }}">Create Trader</a>
								</li>

								<li class="">
									<a href="{{ route('admin.traders.index') }}">View Traders</a>
								</li>
						
								<!-- Link to View Subscribed Trades -->
								<li class="">
									<a href="{{ route('admin.subscriptions.index') }}">View Subscribed Trades</a>
								</li>
							</ul>
						</li>
						...
						<li class="has_sub">
							<a href="#" class="waves-effect subdrop "><i class="fas fa-id-card-alt"></i>
								<span> KYC </span> <span class="pull-right"><i class="fa fa-window-minimize"
										aria-hidden="true"></i></span></a>
							<ul class="list-unstyled" style="display: block;">
								<li class=""><a href="{{route('admin.kyc.index')}}">KYC list</a></li>
							</ul>
						</li>
						...
						<li class="has_sub">
							<a href="#" class="waves-effect subdrop "><i class="fas fa-file-invoice-dollar"></i>
								<span> Voucher </span> <span class="pull-right"><i class="fa fa-window-minimize"
										aria-hidden="true"></i></span></a>
							<ul class="list-unstyled" style="display: block;">
								<li class=""><a href="{{route('vouchers.create')}}">Create Voucher</a></li>
								<li class=""><a href="{{route('vouchers.index')}}">View Vouchers</a></li>
							</ul>
						</li>
