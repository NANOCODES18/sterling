...
@section('body')
            ...
            <div class="col-md-12">
                ...
                <div class="form-group mb-3">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <select id="country-code" name="country_code" class="form-control custom-select" required>
    ...
    <div class="form-group  mb-3">
        ...
        <div class="mb-3">
            <input type="checkbox" name="accept_terms" id="accept_terms" value="agree" required>
            I agree to <a target="_blank" href="{{ route('index') }}" class="checkbox-link">Privacy Policy</a> &
            <a target="_blank" href="#" class="checkbox-link">Terms of Service</a>
            <label class="error red" id="terms"></label>
        </div>

        <!-- Submit Button -->
        <div class="form-group row mb-3">
            <button type="submit" id="submit" class="btn btn-info text-uppercase">Create Account</button>
            <span class="d-inline-block ml-4 text-uppercase" style="margin-right: 10px; width:50%;">
                Or <a style="margin-left: 10px" class="d-inline-block font-weight-500 ml-3"
...
<script>
    document.getElementById('registerForm').addEventListener('submit', function(event) {
        ...
        // Update the phone number input field with the concatenated value
        document.getElementById('phone').value = fullPhoneNumber;

        // Submit the form after updating the phone number
        this.submit();
    });
</script>
